...
public class SupplierPaymentController {
    ...
    public ModelAndView SupplierPaymentUI(){
        ...
        viewPo.addObject("title", "Supplier Payment Management : BIT Project 2023");
  ...
  public String save(@RequestBody SupplierPayment supplierpayment){
    ...
    if(!logUserPrivi.get("insert")){
     ...
     try{
        ...
        for(SupplierPaymentHasGrn grnHasSup : supplierpayment.getSupplierPaymentHasGrnList()){
            grnHasSup.setSupplier_payment_id(supplierpayment);
        }
    ...
    public String update(@RequestBody SupplierPayment suppayment){
        ...
        // suppayment.setUpdated_user(userDao.getUserByUserName(auth.getName()).getId());
          ...
          for(SupplierPaymentHasGrn grnHasSup: suppayment.getSupplierPaymentHasGrnList()){
            grnHasSup.setSupplier_payment_id(suppayment);
        }
