...
public class LoginController {
    ...
    public ModelAndView loginUI(){
        ...
        loginView.addObject("title", "Login : BIT Project 2023");
    ...
    public ModelAndView errorUI(){
        ...
        errorView.addObject("title", "Error : BIT Project 2023");
    ...
    public ModelAndView indexUI(){
        ...
        indexView.addObject("title", "Home : BIT Project 2023");
    ...
    public ModelAndView dashboardUI(){
        ...
        dashbordView.addObject("title", "Dashboard : BIT Project 2023");
